...
VARIABLE_KEYS=(
  ...
  FUTURE_RISK_DAILY_MINUTES_THRESHOLD
  URGENT_LOAD_DAYS
  URGENT_LOAD_MIN_DAILY_MINUTES
  URGENT_LOAD_BOOST
  URGENT_LOAD_HEAVY_MINUTES
  URGENT_LOAD_HEAVY_BOOST
  ONE_OFF_MINUTES
  ONE_OFF_MAX_TASKS
  ONE_OFF_SHARE
  W_PRIORITY
